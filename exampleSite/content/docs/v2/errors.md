---
title: "Errors"
description: "Standard HTTP status codes and machine-readable error payloads."
weight: 40
---
...
All errors return a consistent JSON envelope with a stable, machine-readable
`code`. Match on `code`, not on `message` — wording may change at any time.
...
```json
{
  "error": {
    ...
    "param": "email",
    "doc_url": "https://api.example.org/docs/errors/#parameter_missing"
  }
}
```
